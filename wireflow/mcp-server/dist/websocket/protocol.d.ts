...
export type CanvasElementType = "rectangle" | "ellipse" | "diamond" | "text" | "arrow" | "line" | "freedraw";
export type SemanticTag = "button" | "input" | "section" | "heading" | "nav" | "link" | "listitem" | "dialog" | "table" | null;
...
export type WireFlowRequest = PingRequest | GetStateRequest | GetElementsRequest | GetElementRequest | GetFramesRequest | GetSelectionRequest | CreateRectangleRequest | CreateEllipseRequest | CreateTextRequest | CreateArrowRequest | CreateLineRequest | UpdateElementRequest | DeleteElementsRequest | DeleteSelectedRequest | SelectElementsRequest | ClearSelectionRequest | CreateComponentRequest | ListComponentsRequest | ListFramesRequest | SwitchFrameRequest | CreateFrameRequest;
...
export type ErrorCode = "INVALID_REQUEST" | "UNKNOWN_TYPE" | "ELEMENT_NOT_FOUND" | "FRAME_NOT_FOUND" | "VALIDATION_ERROR" | "CANNOT_DELETE_LAST_FRAME" | "COMPONENT_NOT_FOUND" | "NOT_CONNECTED" | "TIMEOUT" | "INTERNAL_ERROR";
...
export type WireFlowResponse = PongResponse | StateResponse | ElementsResponse | ElementResponse | FramesResponse | SelectionResponse | ElementCreatedResponse | ElementUpdatedResponse | ElementsDeletedResponse | SelectionSetResponse | ComponentCreatedResponse | ComponentsListResponse | FrameCreatedResponse | FrameSwitchedResponse | ErrorResponse;
...
export type WireFlowEvent = ClientConnectedEvent | ClientDisconnectedEvent | StateChangedEvent;
export declare function generateCorrelationId(): CorrelationId;
export declare function generateTimestamp(): Timestamp;
export declare function isErrorResponse(response: WireFlowResponse): response is ErrorResponse;
export declare function isEvent(message: unknown): message is WireFlowEvent;
